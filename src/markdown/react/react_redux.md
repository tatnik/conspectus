...
**Action** — это объект, который описывает какое-то изменение в состоянии. Он всегда должен содержать как минимум свойство type, которое указывает, что именно нужно сделать.
